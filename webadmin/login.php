                            ...
                            <div class="login-form style-2">
                                ...
                                <div class="card-body">
                                    <div class="logo-header text-center">
                                        <a href="javascript:void(0)"><img src="../img/settings/<?= $webSetting['logo'] ?? 'chaincrestcapital-logo-dark.png' ?>" class="img-fluid" width="40%" alt="Coin GainX Logo"></a>
                                    </div>
                                            ...
                                            <div class="tab-content w-100" id="nav-tabContent">
                                                <div class="tab-pane fade show active" id="nav-personal" role="tabpanel"
                                                    ...
                                                    <form class="dz-form pb-3" id="adminLogin">
                                                        <h3 class="form-title m-t0">Coin GainX Admin Login</h3>
